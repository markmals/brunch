        ...
        <Card className="p-0">
            ...
            {isSelected && (
                <>
                    ...
                    <div className="py-6">
                        <h3 className="px-6 text-base font-semibold leading-6 text-gray-900">
                            {title ?? "Unknown"}
                        </h3>
                        ...
                        >
                            ...
                            <div className="flex w-full flex-col divide-y divide-black/10 px-6">
                            ...
                            <div className="flex items-center justify-end gap-x-6 px-6 pb-2 pt-6">
                                <button
                                    ...
                                    disabled={!isDirty || navigation.state !== "idle"}
                                    type="submit"
                                >
